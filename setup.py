...
GITHUB_URL = "https://github.com/dheerajreal/dj-server-ip/"
VERSION = '0.0.1'
...
setup(
    ...
    version=VERSION,
    license='MIT',
    description='get ipv4 addresses of the application host',
    url=GITHUB_URL,
    keywords=['ipv4', 'hostname', 'networking', ],
    py_modules=["dj-server-ip"],
